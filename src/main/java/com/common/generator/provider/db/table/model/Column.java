...
import com.common.generator.provider.db.SqlReservedWords;
import com.common.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.common.generator.provider.db.table.model.util.ColumnHelper;
import com.common.generator.util.GLogger;
import com.common.generator.util.TestDataGenerator;
import com.common.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.common.generator.util.typemapping.DatabaseDataTypesUtils;
import com.common.generator.util.typemapping.JavaPrimitiveTypeMapping;
import com.common.generator.util.typemapping.JdbcType;
...
public class Column implements java.io.Serializable,Cloneable{
	...
	/**
	 * is keyword in db or not
	 */
	private boolean _isKeyWord;
	...
	public Column(Table table, int sqlType, String sqlTypeName,
		...
		//列名是否为关键字
		if (SqlReservedWords.containsWord(sqlName)) {
		   _isKeyWord = true;
		}
		//为了满足mapper文件的生成，sql类型上做了调整
		if(_sqlTypeName.equals("DATETIME")){
			_sqlTypeName = "TIMESTAMP";
		}
		if(_sqlTypeName.startsWith("INT")){
			_sqlTypeName = "INTEGER";
		}
    ...
    public void setKeyWord(boolean v) {
        this._isKeyWord = v;
    }
	/**
